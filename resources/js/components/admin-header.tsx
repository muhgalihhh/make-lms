...
import { Bell, Search, Settings, User, LogOut, Shield, BarChart3, HelpCircle } from 'lucide-react';
                        ...
                        <DropdownMenuContent align="end" className="w-80">
                            ...
                            <div className="max-h-64 overflow-y-auto">
                                ...
                                <DropdownMenuItem className="flex flex-col items-start p-3">
                                    ...
                                    <p className="text-xs text-muted-foreground mt-1">Advanced React course has been completed</p>
                                ...
                                <DropdownMenuItem className="flex flex-col items-start p-3">
                                    ...
                                    <p className="text-xs text-muted-foreground mt-1">New features have been deployed</p>
                                    <span className="text-xs text-muted-foreground mt-1">3 hours ago</span>
                                </DropdownMenuItem>
                            </div>
                            <DropdownMenuSeparator />
                            <DropdownMenuItem asChild>
                                <Link href="#" className="w-full text-center">View all notifications</Link>
                            </DropdownMenuItem>
                        </DropdownMenuContent>
                    </DropdownMenu>
