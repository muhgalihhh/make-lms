...
import { ArrowRight, Award, BookOpen, CloudSun, LifeBuoy, MessageSquare, PlayCircle, ShoppingCart, Star, Users, Zap, Eye, Lock } from 'lucide-react';
        ...
        <div className="min-h-screen bg-background">
                            ...
                            <div className="flex items-center gap-4">
                                ...
                                <div className="flex-1">
                                    <h3 className="text-lg font-semibold text-blue-900 dark:text-blue-100">
                                        Anda sedang melihat sebagai Tamu
                                    </h3>
                ...
                <div className="container mx-auto px-4">
                    ...
                    <div className="mt-8 text-center">
                        <p className="text-sm text-muted-foreground mb-4">
                            * Login atau daftar untuk membeli kelas Pro
                        </p>
                    </div>
                </div>
            </section>
            ...
            <section id="kelas-gratis" className="py-20">
                <div className="container mx-auto px-4">
                    ...
                    <div className="mt-8 text-center">
                        <p className="text-sm text-muted-foreground mb-4">
                            * Login atau daftar untuk mengakses kelas gratis
                        </p>
                    </div>
                </div>
            </section>
            ...
            <footer className="bg-slate-900 text-slate-300 py-12">
                <div className="container mx-auto px-4">
                    <div className="grid grid-cols-1 gap-8 md:grid-cols-4">
                        <div>
                            <h3 className="text-xl font-bold mb-4 text-white">{NAMA_LEMBAGA}</h3>
                        ...
                        <div>
                            ...
                            <ul className="space-y-2 text-slate-400">
                                <li><a href="#" className="hover:text-white transition-colors">Kelas Gratis</a></li>
                                <li><a href="#" className="hover:text-white transition-colors">Kelas Pro</a></li>
